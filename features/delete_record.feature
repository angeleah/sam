Feature: deleting an appointment
	...
	Scenario 1: warning message appears before deleting a record
	...
	Scenario 2: selecting 'yes' on the warning confirmation message to successfully delete a record
		Given I am logged in as Angeleah
			And I have 3 records
		When I click the delete button
	...
	Scenario 3:	selecting 'no' on the warning confirmation message to keep a record
		Given I am logged in as Angeleah
			And I have 3 records
		When I click the delete button
