Feature: edit a note of an existing client
	...
	Scenario: successful save
		...
		Then the info should save 
			And a success message should display that says "You have successfully updated this note."
